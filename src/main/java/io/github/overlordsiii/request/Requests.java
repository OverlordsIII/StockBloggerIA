...
public class Requests {
    ...
    private static final String QUERY_RIVAL_PROMPT = "Give me the stock symbols of PUBLIC companies that rival [STOCK_NAME]. Please ignore any companies that are not currently public on stock exchanges or companies that are owned by other companies. If they are owned by other companies, please list the parent company instead (if that parent company has another parent, list that parent until you get the root parent). Please limit this list to the top 5 rivals and output the list as a numbered list. If the rival is not a public company (one that is not on the NYSE), then omit it. Please ensure this is the rivals STOCK SYMBOL, not their name. Put the name of the company in parenthesis following, like this: \" STOCK_SYMBOL ([STOCK_NAME])\"";
